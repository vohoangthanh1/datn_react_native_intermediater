import { View, Pressable, Text, Image, StyleSheet, TextInput, TouchableOpacity, VirtualizedList, Button, FlatList } from 'react-native'
import React from 'react'
import { KeyboardAwareScrollView } from 'react-native-keyboard-aware-scroll-view'
import { CityStyles } from '../styleSheets/City'
...
const City = () => {
    const renderItem = (value) => {
        ...
        const { item } = value;
        return (
            <View style={CityStyles.contaiCity}>
                <Text style={CityStyles.txtCity}>{item.name}</Text>
    ...
    return (
        <View style={CityStyles.Container}>
            <View style={CityStyles.contaiappbar}>
                <Pressable style={CityStyles.pres}>
                    <Image source={require('../../image/back.png')} />
                </Pressable>
                <View style={CityStyles.contaitxt}>
                    <Text style={CityStyles.txtTille}>CHỌN TỈNH , THÀNH PHỐ</Text>
                </View  >
            </View>
            <View style={CityStyles.contaitxp}>
                <Image source={require('../../image/searchBar.png')} />
                <TextInput placeholder='Nhập từ khóa để lọc' placeholderTextColor={'#9C9C9C'} style={CityStyles.txpserch}>
